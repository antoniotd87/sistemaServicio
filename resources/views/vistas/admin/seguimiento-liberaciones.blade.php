...
@section('content_header')
    <h1 class="text-center">Control de Alumnos Liberados</h1>
@stop
@section('content')
    <div class="card p-2">
        <div class="tab card-body p-0 px-2 pt-2 row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h3 class="m-0 text-dark text-center">Liberados: {{ $datos[0]+$datos[1]+$datos[2]+$datos[3] }} Alumnos</h3>
                        <br>
                        <div class="chart">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h3 class="m-0 text-dark text-center">Liberacion de Servicio Social</h3>
                        <br>
