                ...
                <form action="{{route('solicitudServicio.update', ['estudiante'=>$estudiante->id])}}" method="post" class="row text-center" id="solicitudDependencia">
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                        ...
                        <select name="carreraAlumno" id="carreraAlumno" class="form-control text-center">
                            ...
                            <option value="5">Energias Renovables</option>
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                        ...
                        <input type="number" name="grupoAlumno" id="grupoAlumno" class="form-control text-center"
                            placeholder="Ingrese su grupo" value="">
                    </div>
...
=======
            {{-- {{ dd($estudiante->seguimiento->entidades->entidad) }}
            --}}
            <form action="{{ route('solicitudServicio.update', ['estudiante' => $estudiante->id]) }}" method="post"
                class="row text-center" id="solicitudDependencia">
                @csrf
                @method('PUT')
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 ">
                    <label for="municipioDependencia">Municipio de la dependencia:</label>
                    <input type="text" name="municipioDependencia" id="municipioDependencia"
                        class="form-control text-center" placeholder="Ingrese el nombre del municipio"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->entidad->ENR_municipio : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="nombreDependencia" id="nombreDependencia" class="form-control text-center"
                        placeholder="Ingrese el nombre de la dependencia"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->entidad->ENR_nombre : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="responsableDependencia" id="responsableDependencia"
                        class="form-control text-center" placeholder="Ingrese el nombre del responsable"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->area->ARA_nombreResponsable : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="apellidoPaternoResponsable" id="apellidoPaternoResponsable"
                        class="form-control text-center" placeholder="Ingrese su apellido paterno"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->area->ARA_apellidoPaterno : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="apellidoMaternoResponsable" id="apellidoMaternoResponsable"
                        class="form-control text-center" placeholder="Ingrese su apellido materno"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->area->ARA_apellidoMaterno : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="cargoResponsable" id="cargoResponsable" class="form-control text-center"
                        placeholder="Ingrese cargo del responsable"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->area->ARA_cargo : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="areaServicioSocial" id="areaServicioSocial" class="form-control text-center"
                        placeholder="Ingrese el nombre del area"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->area->ARA_nombre : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="jefeInmediato" id="jefeInmediato" class="form-control text-center"
                        placeholder="Ingrese el nombre del jefe inmediato"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->jefeInmediatos->JEI_nombre : '' }}">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" name="cargoJefeInmediato" id="cargoJefeInmediato" class="form-control text-center"
                        placeholder="Ingrese el cargo del jefe inmediato"
                        value="{{ isset($estudiante->seguimiento->entidades) ? $estudiante->seguimiento->entidades->jefeInmediatos->JEI_cargo : '' }}">
                </div>
                <div class="col-12">
                    <p class="text-left">Esperando contar con su apoyo para poder cumplir con tan importante requisito, en
                        beneficio de la
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                    ...
                    <select name="carreraAlumno" id="carreraAlumno" class="form-control text-center">
                        ...
                        <option {{ $estudiante->EST_carrera == 'Contador Publico' ? 'selected' : '' }}
                            value="Contador Publico">Contador Publico</option>
                        <option {{ $estudiante->EST_carrera == 'Ingenieria Informatica' ? 'selected' : '' }}
                            value="Ingenieria Informatica">Informatica</option>
                        <option {{ $estudiante->EST_carrera == 'Ingenieria Civil' ? 'selected' : '' }}
                            value="Ingenieria Civil">Civil</option>
                        <option
                            {{ $estudiante->EST_carrera == 'Ingenieria en Industrias Alimentarias' ? 'selected' : '' }}
                            value="Ingenieria en Industrias Alimentarias">Industrias Alimentarias</option>
                        <option {{ $estudiante->EST_carrera == 'Ingenieria en Energias Renovables' ? 'selected' : '' }}
                            value="Ingenieria en Energias Renovables">Energias Renovables</option>
                        <option {{ $estudiante->EST_carrera == 'Ingenieria Quimica' ? 'selected' : '' }}
                            value="Ingenieria Quimica">Quimica</option>
                    </select>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                    ...
                    <input type="number" name="creditosAlumno" id="cuentaAlumno" class="form-control text-center"
                        ...
                        value="{{ $estudiante->EST_porcentajeCreditos }}">
                </div>
                ...
                <div class="col-12 row d-flex justify-content-center pr-0 mt-3">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 pr-0">
                        <input type="submit" value="Enviar" class="btn btn-primary btn-block btn-lg ml-1">
>>>>>>> d94a0e52564141368fdca3974192262fc9e15855
                    </div>
                </div>
            </form>
        </div>
