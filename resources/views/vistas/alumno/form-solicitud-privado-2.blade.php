...
@section('content')
<form action="{{route('solicitudPrivado2.update', ['estudiante'=>$estudiante->id])}}" method="post" class="row text-center" id="solicitudPrivado2">
    @csrf
                    @method('PUT')
...
<div class="contenedor-solicitud d-flex w-100 justify-content-between flex-wrap ml-2 text-left">
   ...
   <div class="mr-1 mb-3 flex-grow-1">
    ...
    <div class="mr-2 mb-3">
        <p class="m-0 mt-2">Por medio de este conducto me dirigo a usted de la manera mas atenta para solicitar a las C.</p>
    </div>
    <div class="mr-2 mb-3 flex-grow-1">
    ...
    <div class="mr-2 mb-3">
        <p class="m-0 mt-2"> estudiantes de la carrera de</p>
    </div>
    <div class="mr-2 mb-3 flex-grow-1">
    ...
    <div class="mr-2 mb-3">
        <p class="m-0 mt-2">con numeros de cuenta</p>
    </div>
    ...
    <div class="mr-2 mb-3 flex-grow-1"><input type="number" name="cuenta2" id="cuenta2"
            class="form-control text-center" placeholder="Ingrese su numero de cuenta">
    </div>
    <div class="mr-2 mb-3">
        <p class="m-0 mt-2">;</p>
    </div>
    <div class="mr-2 mb-3">
        <p class="m-0 mt-2"> respectivamente, del Tecnologico de Estudios Superiores de San Felipe del Progreso, para que realice su
    ...
    <div class="col-12 row d-flex justify-content-center pr-0 mt-3">
        ...
        {{-- <a href="{{ route('solicitudPrivado2.imprimir', ['estudiante'=>$estudiante]) }}" target="_blank" class="btn btn-info btn-block">Imprimir</a> --}}
</div>
</form>
@stop
